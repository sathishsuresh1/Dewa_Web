const HtmlSanitizer = new (function () {
    ...
    const _tagWhitelist = {
        'ABBR': true, 'B': true, 'BLOCKQUOTE': true, 'BODY': true, 'BR': true, 'CENTER': true, 'CODE': true, 'DD': true, 'DIV': true, 'DL': true, 'DT': true, 'EM': true, 'FONT': true,
        'H1': true, 'H2': true, 'H3': true, 'H4': true, 'H5': true, 'H6': true, 'HR': true, 'I': true, 'LABEL': true, 'LI': true, 'OL': true, 'P': true, 'PRE': true,
    ...
    const _attributeWhitelist = { 'align': true, 'color': true, 'controls': true, 'height': true, 'href': true, 'id': true, 'style': true, 'target': true, 'title': true, 'type': true, 'width': true };
    ...
    const _schemaWhiteList = ['https:', 'mailto:']; //which "protocols" are allowed in "href", "src" etc
