...
function scInsertCTALink(sender, returnValue) {
  if (!returnValue) {
    return;
  }
  ...
  scEditor.pasteHtml("<div class=\"m17-sectiontitle\"><p class=\"m17-sectiontitle__strong-cta\"><a class=\"button button--primary button--next\" href=\"" + returnValue.url + "\">" + text + "</a></p></div>", "DocumentManager");
}
...
RadEditorCommandList["InsertCTALink"] = function(commandName, editor, args) {
  var d = Telerik.Web.UI.Editor.CommandList._getLinkArgument(editor);
  Telerik.Web.UI.Editor.CommandList._getDialogArguments(d, "A", editor, "DocumentManager");
