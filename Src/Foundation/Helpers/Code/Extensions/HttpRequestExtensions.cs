...
namespace DEWAXP.Foundation.Helpers.Extensions
{
	...
	{
		public static RequestSegment Segment(this HttpRequestBase request)
		{
			return DetermineSegment(request.Headers["User-Agent"]);
		}
        public static RequestSegment Segment(this HttpRequest request)
        {
            return DetermineSegment(request.Headers["User-Agent"]);
        }

        public static RequestSegment Segment(this HttpRequestMessage request)
		{
			return DetermineSegment(request.Headers.UserAgent.ToString());
		}

		public static RequestSegment DetermineSegment(string ua)
		{
			...
			{
				return RequestSegment.Mobile;
			}
			return RequestSegment.Desktop;
		}
	}
}