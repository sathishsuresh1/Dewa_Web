...
namespace DEWAXP.Foundation.Integration.Responses.TenderSvc
{
    ...
    public partial class GetOpenTenderList
    {
        ...
        private GetOpenTenderListTable[] newDataSetField;
        ...
        public GetOpenTenderListTable[] NewDataSet
        {
            get
            {
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class GetOpenTenderListTable
    {
