...
namespace DEWAXP.Foundation.Content.ModelBinders
{
    public class MoveOutModelBinder : System.Web.Mvc.DefaultModelBinder
    {
        public override object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            var model = base.BindModel(controllerContext, bindingContext) as DetailsView; //Bind most of the model using the built-in binder, this will bind all primitives for us
