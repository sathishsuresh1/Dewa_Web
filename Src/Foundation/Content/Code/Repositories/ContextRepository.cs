...
namespace DEWAXP.Foundation.Content.Repositories
{
    ...
    /// </summary>
    [Service(typeof(IContextRepository), Lifetime = Lifetime.Transient)]
    public class ContextRepository : IContextRepository
    {
        ...
        public SupportedLanguage RequestLanguage => "en".Equals(Context.Language.CultureInfo.TwoLetterISOLanguageName, StringComparison.InvariantCultureIgnoreCase) ?
