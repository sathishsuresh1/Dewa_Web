...
namespace DEWAXP.Foundation.CustomDB.DataModel.CustomDataType.DRRG
{
    ...
    /// <summary>
    /// Defines the <see cref="Proc_DRRG_IV_Mgr_RejectionModule" />.
    /// </summary>
    [StoredProcedure("SP_DRRG_SchemaMgr_PVInverterRejection")]
    public class Proc_DRRG_IV_Mgr_RejectionModule
    {
        /// <summary>
