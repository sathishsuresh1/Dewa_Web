...
namespace DEWAXP.Feature.FormsExtensions.SubmitActions.SendEmail.FileAttachment
{
    public class AttachFileUploadProcessor
    {
        private readonly IFileStorageProvider fileStorageProvider;

        public AttachFileUploadProcessor(IFileStorageProvider fileStorageProvider)
        {
