// <copyright file="EpassShorttermController.cs">
// Copyright (c) 2020
// </copyright>
...
namespace DEWAXP.Feature.GatePass.Controllers.Api
{
    ...
    /// </summary>
    public class EpassShorttermController : BaseApiController
    {
        /// <summary>
        ...
        [HttpPost]
        public HttpResponseMessage Getpassedrecords()
        {
            List<CSVfileformat> model = new List<CSVfileformat>();
            if (CacheProvider.TryGet(CacheKeys.EPASS_MULTIPASS_SHORTTERM_LIST, out model))
            {
